...
object RunGcamBatch {
    ...
    def main(args: Array[String]) : org.apache.spark.sql.DataFrame = {
    	...
    	val gkg_core_schema = new StructType(Array(
    	...
    	val gkg_file_raw = new sqlContext.read
        ...
        time_series.write.parquet(outputDir)
        }
...
RunGcamBatch("s3://raw-gkg-gdelt/*", "s3://gdelt.storage/")
